...
interface RegisterGeneratorOptions {
  baseURL: string;
}

interface RegisterGeneratorArguments {
  name: string;
}

interface RegisterGenerator {
  options: RegisterGeneratorOptions & RegisterGeneratorArguments;
}

class RegisterGenerator extends Generator {
